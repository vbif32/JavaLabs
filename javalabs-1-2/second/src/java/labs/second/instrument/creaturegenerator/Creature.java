...
public class Creature {
    ...
    protected Creature(Body body, Head head, Paws paws, Tail tail, Wings wings, Hornes horn) {
        this.body = body;
        this.head = head;
        this.paws = paws;
        this.tail = tail;
    ...
    public static Creature UNICORN = new Creature(Body.HORSE,Head.HORSE,Paws.HORSE,Tail.HORSE,null,Hornes.Uniue);
